...
function formSheet() {
    ...
    var response = ui.alert(
        "Bạn có muốn thiết lập Tiếng Việt làm ngôn ngữ mặc định? \n If you want to set English as your default language, please click on No or turn off this form",
        ui.ButtonSet.YES_NO
    );
    ...
    if (language == "EN")
        ...
        SpreadsheetApp.getUi().alert(
            "Vui lòng chọn Input API key trong Menu trước khi kích hoạt các chức năng khác"
        );
}
