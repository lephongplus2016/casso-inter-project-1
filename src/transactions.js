...
function getTransaction(fromDate, token) {
  ...
  function compareDate(date01, date02) {
      var thisdate1 = date01.toString().substring(0, 2);
      var thismonth1 = date01.toString().substring(3, 5);
      var thisyear1 = date01.toString().substring(6, 10);
      let new1 = new Date(thisyear1, thismonth1 - 1, thisdate1);
  
      var thisdate2 = date02.toString().substring(0, 2);
      var thismonth2 = date02.toString().substring(3, 5);
      var thisyear2 = date02.toString().substring(6, 10);
